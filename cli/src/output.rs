...
Options:
  ...
  -p, --provider <name>      Browser provider: ios, browserbase, kernel, browseruse, browserfarm
...
Environment:
  ...
  AGENT_BROWSER_PROVIDER         Browser provider (ios, browserbase, kernel, browseruse, browserfarm)
